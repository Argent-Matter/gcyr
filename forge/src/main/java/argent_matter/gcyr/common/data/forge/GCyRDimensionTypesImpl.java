...
public class GCyRDimensionTypesImpl {
    ...
    private static final DeferredRegister<Codec<? extends ChunkGenerator>> CHUNK_GENERATOR_REGISTER = DeferredRegister.create(Registry.CHUNK_GENERATOR_REGISTRY, GCyR.MOD_ID);
