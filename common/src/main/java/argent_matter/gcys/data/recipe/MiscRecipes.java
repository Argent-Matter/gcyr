...
public class MiscRecipes {
    public static void init(Consumer<FinishedRecipe> provider) {
        ...
        GTRecipeTypes.CHEMICAL_BATH_RECIPES.recipeBuilder(GregicalitySpace.id("fiberglass"))
        ...
        GTRecipeTypes.ASSEMBLER_RECIPES.recipeBuilder(GregicalitySpace.id("space_fabric"))
