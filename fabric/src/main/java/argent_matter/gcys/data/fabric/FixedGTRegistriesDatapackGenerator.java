...
public class FixedGTRegistriesDatapackGenerator extends RegistriesDatapackGenerator {
    private final String name;
    private final PackOutput output;
    private final CompletableFuture<HolderLookup.Provider> registries;
    private final java.util.function.Predicate<String> namespacePredicate;

    private FixedGTRegistriesDatapackGenerator(String name, PackOutput output, CompletableFuture<Provider> registries, Set<String> modIds) {
    ...
    public FixedGTRegistriesDatapackGenerator(PackOutput output, CompletableFuture<Provider> registries, RegistrySetBuilder builder, Set<String> modIds, String name) {
