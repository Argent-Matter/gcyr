...
public class GCYRTrimMaterials {
    ...
    public static final ResourceKey<TrimMaterial> SPACE = ResourceKey.create(Registries.TRIM_MATERIAL,
            GCYR.id("space"));
    ...
    private static void register(BootstapContext<TrimMaterial> context, ResourceKey<TrimMaterial> materialKey,
                                 Item ingredient, Style style, float itemModelIndex) {
    ...
    private static void register(
        ...
        TrimMaterial trimMaterial = TrimMaterial.create(
                ...
                ingredient,
                itemModelIndex,
                Component.translatable(Util.makeDescriptionId("trim_material", materialKey.location()))
                        .withStyle(style),
