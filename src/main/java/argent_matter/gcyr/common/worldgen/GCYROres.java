...
public class GCYROres {
    ...
    public static final GTOreDefinition RARE_EARTH_METAL_VEIN_MARS = create(GCYR.id("rare_earth_metal_vein_mars"),
            vein -> vein
                    .clusterSize(30).density(0.3f).weight(40)
                    .layer(GCYRWorldGenLayers.MARS)
                    .heightRangeUniform(10, 80)
    ...
    public static final GTOreDefinition TUNGSTOTITANATE_VEIN_VENUS = create(GCYR.id("tungstotitanate_vein_venus"),
            vein -> vein
                    .clusterSize(30).density(0.3f).weight(40)
    ...
    public static final GTOreDefinition MERCURY_VEIN_MERCURY = create(GCYR.id("mercury_vein_mercury"), vein -> vein
            .clusterSize(30).density(0.3f).weight(40)
