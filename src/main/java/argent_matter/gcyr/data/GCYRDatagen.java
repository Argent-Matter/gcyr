...
import argent_matter.gcyr.data.recipe.pregenerated.GCYRStaticRecipes;
...
public class GCYRDatagen {
    ...
    public static void init() {
        GCYRRegistries.REGISTRATE.addDataGenerator(ProviderType.RECIPE, GCYRStaticRecipes::init);
