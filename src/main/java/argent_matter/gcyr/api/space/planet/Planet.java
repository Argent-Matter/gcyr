...
public record Planet(String translation, ResourceLocation galaxy, ResourceLocation solarSystem,
    ...
    public static final Codec<Planet> DIRECT_CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            ResourceKey.codec(Registries.DIMENSION).fieldOf("orbit_dimension").forGetter(Planet::orbitDimension),
    ...
    public static final Codec<Planet> ID_CODEC = ResourceLocation.CODEC.flatXmap(
            rl -> Optional.ofNullable(PlanetData.getPlanet(rl))
    ...
    public static final Codec<Planet> CODEC = Codec.either(ID_CODEC, DIRECT_CODEC)
            .xmap(GTCodecUtils::unboxEither, Either::left);
    // spotless:on
}
