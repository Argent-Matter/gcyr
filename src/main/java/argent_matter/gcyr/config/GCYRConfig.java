...
public class GCYRConfig {
    ...
    public static class MachineConfigs {
        ...
        @Configurable
        @Configurable.Comment({ "Damage caused by standing in an active dyson system controller's beam. (per tick)",
                "Default: 5.0" })
    ...
    public static class RocketConfigs {
        ...
        @Configurable
        @Configurable.Comment({ "How much fuel is required to travel to a planet in the same solar system?",
                "Default: 14 buckets." })
        public int solarSystemFuelAmount = 14 * FluidType.BUCKET_VOLUME;
        @Configurable
        @Configurable.Comment({ "How much fuel is required to travel to a planet in the same galaxy?",
                "Default: 26 buckets." })
